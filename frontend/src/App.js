        ...
        <div className="min-h-screen bg-gray-900 text-white">
            ...
            <main>
                <section ref={heroRef} id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-cover bg-center bg-no-repeat transform scale-105 transition-transform duration-1000 parallax" style={{ backgroundImage: `url('frontend/public/petra.webp')`, transform: `translateY(${scrollProgress * 0.5}px) scale(1.1)`}}></div>
                ...
                <section ref={arRef} id="ar" className="py-20 bg-gray-800/50">
                    <div className="container text-center">
                        ...
                        <a href="ar.html" target="_blank" rel="noopener noreferrer" className="btn btn-primary">🥽 Launch AR Guide</a>
                    </div>
                </section>
            ...
            <footer className="relative bg-gray-900 border-t border-gray-800">
                <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: `url(frontend/public/petra.webp')` }}></div>
